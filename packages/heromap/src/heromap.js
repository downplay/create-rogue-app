...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "main", "symbols": ["_", "lines", "legend", "_"], "postprocess": d => mapNode({ lines: d[1], legend: d[2] })},
    {"name": "lines$ebnf$1", "symbols": ["mapline"]},
    {"name": "lines$ebnf$1", "symbols": ["lines$ebnf$1", "mapline"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "lines", "symbols": [(lexer.has("mapstart") ? {type: "mapstart"} : mapstart), "lines$ebnf$1"], "postprocess": ([_, mapline]) => mapline},
    ...
    {"name": "applyOp", "symbols": ["__", "stuff", "__", {"literal":"="}, "__", "brushes"], "postprocess": d => brushOpNode({target: d[1], brush: brushNode(andBrushesNode(d[5])) })},
    {"name": "groupOps", "symbols": ["groupOp"], "postprocess": d => [d[0]]},
    {"name": "groupOps", "symbols": ["groupOps", "__", {"literal":"|"}, "groupOp"], "postprocess": d => [...d[0], d[3]]},
    {"name": "groupOp$ebnf$1", "symbols": ["quantifier"], "postprocess": id},
    {"name": "groupOp$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "groupOp", "symbols": ["__", {"literal":"("}, "legend", "_", {"literal":")"}, "groupOp$ebnf$1"], "postprocess": d => operationGroupNode(d[2], d[5])},
    {"name": "brushes", "symbols": ["brush"], "postprocess": d => [brushNode(d[0])]},
    {"name": "brushes", "symbols": ["brushes", "__", {"literal":"+"}, "__", "brush"], "postprocess": d => [...d[0], brushNode(d[4])]},
    {"name": "brush", "symbols": ["switch"], "postprocess": d => orBrushesNode(d[0])},
    ...
    {"name": "option", "symbols": ["option$subexpression$1", "option$ebnf$1"], "postprocess": d => brushNode(d[0][0], d[1])},
    ...
    {"name": "percentage", "symbols": [(lexer.has("number") ? {type: "number"} : number), {"literal":"%"}], "postprocess": d => percentageValue(Number(d[0])/100)},
    {"name": "group", "symbols": [{"literal":"("}, "_", "brushes", "_", {"literal":")"}], "postprocess": d => andBrushesNode(d[2])},
    {"name": "stuff", "symbols": ["glyphs"], "postprocess": d => glyphsNode(d[0])},
    {"name": "stuff", "symbols": [(lexer.has("word") ? {type: "word"} : word)], "postprocess": d => wordNode(d[0].value)},
    {"name": "stuff", "symbols": ["glyph"], "postprocess": d => glyphNode(d[0])},
